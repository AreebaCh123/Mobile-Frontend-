...
const styles = StyleSheet.create({
  ...
  taskTextWrap: { flex: 1 },
  taskTitle: { ...type.body, color: colors.text, fontWeight: '600' },
  taskSub: { ...type.caption, color: colors.mutedText, marginTop: 2 },
  chevron: { fontSize: 20, color: colors.mutedText, marginLeft: spacing.md },
