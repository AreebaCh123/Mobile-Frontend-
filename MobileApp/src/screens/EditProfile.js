    ...
    try {
      ...
      if (status !== 'granted') {
        Alert.alert(
          ...
          'To select a photo, please allow photo library access in your device settings.',
          [
            { text: 'Cancel', style: 'cancel' },
            { text: 'Open Settings', onPress: () => {
              // This would open device settings in a real app
              Alert.alert('Settings', 'Please go to Settings > Apps > MindMate > Permissions and enable Photo Library access.');
            }}
          ]
        );
        return;
